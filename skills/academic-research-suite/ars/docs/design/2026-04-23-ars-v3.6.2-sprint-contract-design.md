> Upstream design/plan document, vendored for traceability. NOT a Codex runtime instruction. References to "superpowers:*" skills, `/Users/imbad/...` paths, or "Claude Code session" describe the upstream development environment.
